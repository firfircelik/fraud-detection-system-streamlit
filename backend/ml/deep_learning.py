...
class EnsembleDeepLearning:
    ...
    def train_ensemble(self, X_train, y_train, X_val, y_val, epochs: int = 100):
        ...
        for name, model in self.models.items():
            ...
            if isinstance(model, (AutoEncoder, LSTMFraudDetector, 
                                TransformerFraudDetector, GraphNeuralNetwork)):
                # PyTorch models
...
if __name__ == "__main__":
    ...
    ensemble.add_model("transformer", TransformerFraudDetector(input_dim=50), weight=1.1)
