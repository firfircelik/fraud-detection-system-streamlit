...
class FeatureEngine:
    ...
    def extract_behavioral_features(self, transaction: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            with self.session_local() as session:
                ...
                if amounts:
                    ...
                    features['user_std_amount'] = float(df.std()) if len(amounts) > 1 else 0.0
                    ...
                    features['amount_percentile'] = float(df.rank(pct=True).iloc[-1]) if len(amounts) > 1 else 0.5
                    ...
                    features['is_amount_outlier'] = amount < lower_bound or amount > upper_bound
    ...
    def extract_merchant_features(self, transaction: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            features['is_high_risk_category'] = any(risk_cat in category for risk_cat in high_risk_categories)
    ...
    def extract_geographic_features(self, transaction: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            if lat and lon:
                ...
                country_risks = {
                    ...
                    'FR': 0.15, 'IT': 0.2, 'ES': 0.2, 'BR': 0.3, 'IN': 0.25,
                    'CN': 0.4, 'RU': 0.6, 'NG': 0.7, 'UNKNOWN': 0.8
                }
        ...
        try:
            for message in self.kafka_consumer:
                ...
                if features:
                    ...
                    logger.info(f"✅ Features extracted for transaction: {features['transaction_id']}")
                else:
